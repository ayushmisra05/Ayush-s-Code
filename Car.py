...
class Car:
    ...
    def get_make(self): #returning the values
        return self.__make

    def set_make(self, newMake): #Updates, initializes the value (Takes two variables for set)
        self.__make = newMake

    def get_model(self): #returning the values
        return self.__model

    def set_model(self, newModel): #Updates, initializes the value (Takes two variables for set)
        self.__model = newModel

    def get_mpg(self): #returning the values
        return self.__mpg

    def set_mpg(self, newMpg): #Updates, initializes the value (Takes two variables for set)
        self.__mpg = newMpg
